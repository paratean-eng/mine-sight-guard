...
import { mockAlerts, mockSensorData, mockAINotifications } from '@/data/mockData';
import { 
  MessageSquare, 
  Monitor, 
  Settings, 
...
const WelcomePage = ({ user, onLogout }: WelcomePageProps) => {
  ...
  const activeSensors = mockSensorData.filter(sensor => sensor.status !== 'critical').length;
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="glass-panel border-glass-border/50">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-alert-safe mb-1">
                98%
              </div>
          ...
          <CardContent>
            <div className="space-y-4">
              {mockAlerts.slice(0, 3).map((alert) => (
                <div key={alert.id} className="flex items-center justify-between p-3 bg-glass/30 rounded-lg">
